...
public partial class profilePageUser : ContentPage
{
    ...
    {
        await AnimationUtilities.ChangeFrameColor(frameHistorial, Color.FromRgb(53, 172, 226), Color.FromRgb(211, 211, 211), 250);
    ...
    {
        await AnimationUtilities.ChangeFrameColor(frameCambiarcontrasenia, Color.FromRgb(53, 172, 226), Color.FromRgb(211, 211, 211), 250);
